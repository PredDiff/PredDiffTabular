...
def empirical_bootstrap(input_tuple, score_fn, ids=None, n_iterations=100, alpha=0.95, threads=None,
    ...
    if fast_evaluation is False:
        ...
        # TODO: warning is generated somewhere here
        #  sklearn.ensemble.forest module is  deprecated in version 0.22 and will be removed in version 0.24.
        #  The corresponding classes / functions should instead be imported from sklearn.ensemble.
        if ids is None:
            ids = []
